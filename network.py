...
def discriminator(input, is_train=True, reuse=False, batch_size=64, df_dim=64, image_zise=64):
    ...
    with tf.variable_scope('discriminator', reuse=reuse) as scope:
        ...
        h4 = linear(tf.reshape(h3, [-1, df_dim*8*s16*s16]), 1,  name="d_4_linear")
